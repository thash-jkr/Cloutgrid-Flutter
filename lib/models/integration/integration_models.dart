...
@freezed
abstract class ReachValue with _$ReachValue {
  const factory ReachValue({required int value, required String date}) =
      _ReachValue;

  factory ReachValue.fromJson(Map<String, dynamic> json) =>
      _$ReachValueFromJson(json);
}
