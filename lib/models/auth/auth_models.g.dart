...
_UserProfile _$UserProfileFromJson(Map<String, dynamic> json) => _UserProfile(
  ...
  instagramFollowers: (json['instagram_followers'] as num?)?.toInt(),
  youtubeSubscribers: (json['youtube_subscribers'] as num?)?.toInt(),
...
Map<String, dynamic> _$UserProfileToJson(_UserProfile instance) =>
    <String, dynamic>{
      ...
      'instagram_followers': instance.instagramFollowers,
      'youtube_subscribers': instance.youtubeSubscribers,
